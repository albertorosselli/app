      ...
      no: {
        ...
        proof: {
          ...
          benefits: [
            ...
            { title: 'Kobling Google + nettside', description: 'Konsistente data gir bedre synlighet og trygghet.' },
        ...
        contact: {
          ...
          footerLine3: 'Laget og drevet av Alberto Rosselli',
      ...
      en: {
        ...
        proof: {
          ...
          benefits: [
            ...
            { title: 'Google + site connection', description: 'Consistent data boosts visibility and trust.' },
        ...
        contact: {
          ...
          footerLine3: 'Built and run by Alberto Rosselli',
